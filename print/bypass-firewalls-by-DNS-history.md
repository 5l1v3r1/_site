...
So the response body of http will be empty, causing false positives to appear.
...
# hide verbose output curl, somehow --silent is not enough when verbose is on.
